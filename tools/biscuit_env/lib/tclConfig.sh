...
# installed.
TCL_PREFIX='/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib -Wl,-rpath-link,/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib -L/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/include'
...
TCL_PACKAGE_PATH='{/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tcl8.6.12/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/omics/odcf/analysis/OE0290_projects_temp/pediatric_tumor/EMseq/tools/biscuit_env/lib/libtclstub8.6.a'
